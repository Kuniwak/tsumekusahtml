...
/** @override */
HtmlListItemPublisher.prototype.publish = function(list) {
 ...
 * @param {module:tsumekusa.List.ListItem} list Tsumekusa element.
 * @return {module:lib/html/HtmlElement} HTML element.
 */
HtmlListItemPublisher.prototype.createListDom = function(list) {
  return new HtmlElement('li', false, list.getBlockElements().publish());
};
