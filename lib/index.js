...
module.exports = {
  ...
  util: {
     ...
     */
    get HtmlElement() {
      defProp(this, 'HtmlElement', {
        value: require(basePath + '/html/HtmlElement')
      });
    ...
    get HtmlAnchorElement() {
      defProp(this, 'HtmlAnchorElement', {
        value: require(basePath + '/html/HtmlAnchorElement')
      });
      return this.HtmlAnchorElement;
    }
  }
};
