...
HtmlContainerPublisher.prototype.createHeaderDom = function(container) {
  var header = new HtmlElement('h' + (container.getDepth() + 1), false,
      container.getCaption());
  header.setAttribute('id', container.getReferenceId());
  return header;
};


/** @override */
HtmlContainerPublisher.prototype.getIndentWidth = function(content) {
  return 0;
};
